...
const themes = {
  ...
  arctic: {
    ...
    vars: {
      ...
      '--color-success-text': '#167d3c',
      '--color-warning-text': '#966107',
      '--color-danger-text': '#c73939',
  ...
  sunset: {
    ...
    vars: {
      ...
      '--color-text-muted': '#a08678',
      '--color-success-text': '#22c55e',
      '--color-warning-text': '#f59e0b',
      '--color-danger-text': '#f05454',
